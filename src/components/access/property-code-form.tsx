  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl" noValidate>
      ...
      <p id="property-code-help" className="mt-2 text-sm leading-6 text-slate-500">
        Use o código recebido na reserva ou exibido no QR Code do imóvel.
      </p>
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <input
          ...
          className="h-14 min-w-0 flex-1 rounded-2xl border border-slate-200 bg-white px-4 text-base font-semibold tracking-wide text-[#06243d] shadow-sm outline-none transition placeholder:font-medium placeholder:text-slate-400 focus:border-[#0067b1] focus:ring-4 focus:ring-[#10b6d6]/15"
          autoComplete="off"
          inputMode="text"
        ...
        <button
          ...
          className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl bg-[#ff8a1c] px-6 font-semibold text-white shadow-sm transition hover:bg-[#f47c08] focus:ring-4 focus:ring-[#ff8a1c]/25 focus:outline-none disabled:cursor-not-allowed disabled:bg-slate-300 sm:min-w-44"
        >
